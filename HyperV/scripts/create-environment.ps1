...
ExecRetry {
    ...
    git fetch https://git.openstack.org/openstack/os-brick refs/changes/81/323781/12
    ...
    git fetch https://git.openstack.org/openstack/os-brick refs/changes/80/323780/12
    cherry_pick FETCH_HEAD
