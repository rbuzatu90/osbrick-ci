...
result_init=$?
echo "$ZUUL_PROJECT;$ZUUL_BRANCH;$jen_date;$JOB_TYPE;$ZUUL_CHANGE;$ZUUL_PATCHSET;init;$result_init" >> /home/jenkins-slave/osbrick-statistics.log
...
if [ $result_init -eq 0 ]; then
    ...
    if [[ ! -z $RUN_TESTS ]] && [[ $RUN_TESTS == "no" ]]; then
        ...
        result_tempest=$?
        echo "$ZUUL_PROJECT;$ZUUL_BRANCH;$jen_date;$ZUUL_CHANGE;$ZUUL_PATCHSET;run;$result_tempest" >> /home/jenkins-slave/osbrick-statistics.log
